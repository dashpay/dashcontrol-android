...
public class URLs {
    ...
    private final static String BASE_URL_DASH_CONTROL = "https://www.dashcentral.org/api/v1/"
    ;
    ...
    public static final String URL_GRAPH = BASE_URL_DASH_CONTROL + "https://dashpay.info/api/v0/chart_data?";
